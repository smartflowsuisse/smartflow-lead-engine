          ...
          <div className="rounded-3xl border border-slate-800 bg-slate-900 p-6 lg:col-span-3">
            ...
            <div className="mt-6 grid gap-4 md:grid-cols-3">
              ...
              <div className="rounded-2xl border border-slate-800 bg-slate-950 p-5">
                ...
                <p className="mt-3 text-sm leading-6 text-slate-400">
                  Prepare a manual follow-up task and review the request before
                  any external action.
                </p>
              </div>
              ...
              <div className="rounded-2xl border border-slate-800 bg-slate-950 p-5">
                ...
                <p className="mt-3 text-sm leading-6 text-slate-400">
                  The suggested reply is still a draft and requires human
                  approval before any Gmail draft or external action can happen.
                </p>
              </div>
            </div>
          </div>
